<?php if(isset($_POST['add_post'])){
	...
	if(in_array($actual_extension,$allowed_extension)){
		if($image_size < 2048000){
			/* inserting post with when the image are proper type and etc */
			...
			/* We have to use proper image name for preventing over writing of image so i have used a 
			patter like profile+post_id with this we cannot event over wirte */
