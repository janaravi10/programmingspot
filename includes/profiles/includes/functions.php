...
function delete_comment(){
	/*function to delete comments, approve comments , unapprove comments */
  global $connection;
...
function users_online(){
	/* function to show the number of user availabel online */
global $connection;
$session = session_id();
$time = time();
$time_out_seconds = 60;
...
function check_username_availability(){
	/* checking whether the enter username is availabel */
global $connection;
...
function add_bulk_option(){
	global $connection;
	/* function to add bulk option to delete more than one post or cloning */
...
{
	/* function to send message to others */
	global $connection;
...
{
	/* showing the message when user click message when logged user click other */
	global $row_image;
	 global $connection;
...
{
	/* showing the the user name which the logged in user messaged to */
...
{
	/* indicating the user when he receiving the message by bring all message which has flag 1*/
...
{
	/* we setting the message flag to 0 when user see the message */
