<?php if(isset($_POST['add_post'])){
	...
	if(in_array($actual_extension,$allowed_extension)){
		/* checking the sie and type of image user uploading */
		if($image_size < 2048000){
			/* using prepared statement to add post */
			...
			/* updating the post image after getting the last post_id */
