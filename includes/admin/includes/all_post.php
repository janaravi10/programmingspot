...
<div id="tableWrapper">
   <form action="" method="post" id="bulkOptionForm">
 	...
 	<tbody>
    <?php
	/* showing all post related to the user */
	$query = "SELECT posts.post_id, posts.post_title, posts.post_author, posts.post_status, posts.post_tags, posts.post_image,";
	$query .= " posts.post_cat_id, posts.post_date, categories.cat_id, categories.cat_title";
	$query .= " FROM posts LEFT JOIN categories ON posts.post_cat_id = categories.cat_id ORDER BY post_id DESC ";
