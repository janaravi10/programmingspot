...
<?php
  if (isset($_SESSION['user_role'])) {
    /* prevetning the access of our application */
...
if(isset($_GET['receiver_id'])){
  ...
  ?>
  <script>
  /* echoing the session and receiver id to send message to him using ajax*/
...
<div id="wrapper">
  ...
  <div id="page-wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-lg-12">
          <h1 class="page-header">
            ...
            /* echoing the user image for using in messaging */
     ...
     <div class="col-md-12">
     	<div class="col-md-6">
     <div class="messagedUser">
     <?php 
     /* function will show whether user is already messaged to another person */
      show_messaged_user(); ?></div>
...
<div class="col-md-6 col-xs-12" >
    ...
    <div id="message">
 <?php /* this function will show the messge when user click specific another user */
 show_message(); ?>
    </div>
...
if (isset($receiver_id)) {
  /* this code will show the which user we are sending messaging */
